 ...
 */
drop table if exists $$schema.load_tp_master;
create table $$schema.load_tp_master
(
load_key int,
load_tp varchar(20),
...
insert into $$schema.load_tp_master values(1,'incremental','short_batch','Y')
insert into $$schema.load_tp_master values(2,'full','daily','Y')
/*
 Table :- load_details
 ...
 */
drop table if exists $$schema.load_details;
create table $$schema.load_details
(
src_tbl varchar(200),
tgt_tbl varchar(200),
load_key int,
...
/*please update the below statement with appropriate values from your environment*/
insert into $$schema.load_details values ('fed_postgres_tpc_ds.web_sales_test_load', 'public.rs_stg_web_sales',1,'d_date',1000000000,'Y');
insert into $$schema.load_details values ('fed_postgres_tpc_ds.date_dim', 'public.rs_stg_date_dim',1,'d_date',1000000000,'Y');
 ...
 */
drop table if exists $$schema.login_parameters;
create table $$schema.login_parameters
(
...
/*please update the below statement with appropriate values from your environment*/
insert into $$schema.login_parameters values ('redshift-cluster-2','awsuser','dev','public.etlfw_rs_table_load_details','public.etlfw_load_businessdate');
