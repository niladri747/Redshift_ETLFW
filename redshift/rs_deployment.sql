...
create table $$schema.load_businessdate
(
src_tbl varchar(200),
load_key int,
...
insert into db_etlfw.load_businessdate values ('fed_postgres_tpc_ds.web_sales_test_load', 1, '2002-12-31');
insert into db_etlfw.load_businessdate values ('fed_postgres_tpc_ds.date_dim', 1, '1900-01-01');


/*
 Table :- etlfw_load_businessdate
 Description:- Stores max of last modified record timestamp
 Timestamp for this batch. Used to timestamp the log
 ...
 row_count:-  Total no of rows inserted.deleted.ipdated
 :-
 */
